...
from domains.ats_result import (
    ATSResult,
    AliasMatch,
    SemanticMatch,
)
...
def calculate_ats_score(
    ...
    alias_matches_raw, alias_jd_skills = alias_match(
        resume_skills,
        jd_skills,
    )
    ...
    alias_matches = [
        ...
        for match in alias_matches_raw
    ...
    semantic_matches_raw, missing_skills = semantic_match(
        resume_skills,
        unmatched_jd_skills,
    )
    ...
    semantic_matches = [
        ...
        for match in semantic_matches_raw
